export const datosPrueba = [
  ...
  },
  {
    ...
    pasos: [
      "Hierve la leche con la canela y cáscara de limón.",
      "Agrega el arroz y cocina a fuego lento.",
      "Remueve constantemente durante 30 minutos.",
      "Agrega el azúcar y cocina 10 minutos más.",
      "Deja enfriar antes de servir."
    ],
    formTip: "Espolvorea canela en polvo al servir para más aroma.",
    formDescripcionBreve: "Postre cremoso de arroz y leche.",
    formDescripcionAmplia: "Una receta tradicional y reconfortante que recuerda a la cocina de la abuela. Ideal como postre o merienda."
  },
]